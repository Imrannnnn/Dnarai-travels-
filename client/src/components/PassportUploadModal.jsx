            ...
            {status !== 'idle' ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex justify-end gap-3 pt-4 border-t border-slate-100 dark:border-slate-800">
                        ...
                        <button
                            type="submit"
                            className="group flex items-center gap-2 rounded-xl bg-ocean-600 px-6 py-3 text-sm font-bold text-white shadow-lg shadow-ocean-600/20 transition-all hover:bg-ocean-700 hover:scale-[1.02] active:scale-95"
                        >
                            <Shield size={16} />
